    ...
    <div className="container mx-auto px-4 py-12 md:py-24">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
        <div>
          <h2 className="text-2xl font-semibold mb-4">
            {text.pt.our_story.title}
          </h2>
          {text.pt.our_story.content.map((paragraph, index) => (
      ...
      <div className="mb-16">
        <h2 className="text-2xl font-semibold mb-4 text-center">
          {text.pt.our_mission.title}
        </h2>
        <p className="text-lg text-center max-w-2xl mx-auto text-balance">
          {text.pt.our_mission.content}
        </p>
      </div>

      <div className="grid md:grid-cols-3 gap-8 mb-16">
        {text.pt.features.map((feature, index) => (
      ...
      <div className="text-center">
        <h2 className="text-2xl font-semibold mb-4">{text.pt.cta.title}</h2>
        <Button asChild size="lg">
          <Link href="/signup">{text.pt.cta.button}</Link>
        </Button>
      </div>
    </div>
  );
